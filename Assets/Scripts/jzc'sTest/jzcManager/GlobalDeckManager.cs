...
public class GlobalDeckManager : MonoBehaviour
{
    ...
    {
        if (card_deck.Count == 0 || num <= 0) return new List<CrackedCardData>(); // �������Ϊ�ջ�����������С�ڵ���0���򷵻ؿ��б�

        if (num >= card_deck.Count) return getDuplicatedDeck(); // ����������������ڵ��ڿ����е��������򷵻ؿ���ĸ���

        List<CrackedCardData> result = new List<CrackedCardData>();

        while (result.Count < num)
        {
            int randomIndex = UnityEngine.Random.Range(0, card_deck.Count); // �����ȡ�����е�һ������
            CrackedCardData randomCard = card_deck[randomIndex]; // ��ȡ�����ж�Ӧ�����Ŀ���
            if (!result.Contains(randomCard)) result.Add(randomCard); // �������б��в������ÿ��ƣ������ӵ�����б���
        }
    ...
    public int deleteCards(List<CrackedCardData> cardsToDelete)
    {
        ...
        if (card_deck.Count > 0)
        {
            ...
            {
                bool removed = card_deck.Remove(card); // �����Ƴ����ƣ�����¼���
                if (!removed)
                {
                    failedDeletions++; // ����Ƴ�ʧ�ܣ�����ʧ�ܼ�����
                }
                else if (cardBank != null) // ����Ƴ��ɹ�������cardBank��Ϊ��
                {
                    cardBank.RemoveCardFromBank(card); // ��cardBank���Ƴ�����
                }
            }
        }
