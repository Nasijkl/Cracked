...
[CreateAssetMenu(fileName = "LandofReiki2", menuName = "Incident/IncidentPageData/LandofReiki/LandofReiki2")]
public class LandofReiki2 : IncidentPageData
{
    ...
    public override void Resolve()
    {
        ...
        if (player != null)
        {
            ...
            float healthGain = playerHealth.maxHealth * 0.25f;
            float staminaGain = 25f;
